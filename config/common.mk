...
# Arrow specific permissions
PRODUCT_COPY_FILES += \
    vendor/arrow/config/permissions/privapp-permissions-arrow-system_ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-arrow-system_ext.xml
