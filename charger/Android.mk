...
define _add-arrow-charger-image
include $$(CLEAR_VARS)
LOCAL_MODULE := arrow_core_charger_$(notdir $(1))
...
$(foreach _img, $(call find-subdir-subdir-files, "images/$(charger_density)", "*.png"), \
  $(eval $(call _add-arrow-charger-image,$(_img))))

include $(CLEAR_VARS)
LOCAL_MODULE := arrow_charger_res_images
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_OWNER := arrow
